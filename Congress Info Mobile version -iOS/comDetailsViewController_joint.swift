//
//  comDetailsViewController_joint.swift
//  CongressInfo
//
...
class comDetailsViewController_joint: UIViewController,UITableViewDataSource,UITableViewDelegate {

    @IBOutlet weak var comName: UITextView!
    @IBOutlet weak var tblJSON_comJointDetail: UITableView!
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if indexPath.section == 0 {
            let cell_0 = tableView.dequeueReusableCell(withIdentifier: "jsonCell_comJoint_1") as! CustomCell_Com_Detail
            cell_0.text1_L.text = "ID"
            cell_0.text1_R.text = (recData[0]["committee_id"] as? String)!
            return cell_0
        }
        else if indexPath.section == 1 {
            let cell_1 = tableView.dequeueReusableCell(withIdentifier: "jsonCell_comJoint_1") as! CustomCell_Com_Detail
            ...
            let cell_2 = tableView.dequeueReusableCell(withIdentifier: "jsonCell_comJoint_1") as! CustomCell_Com_Detail
            cell_2.text1_L.text = "Chamber"
            cell_2.text1_R.text = (recData[0]["chamber"] as? String)!
            return cell_2
        }
        else if indexPath.section == 3 {
            let cell_3 = tableView.dequeueReusableCell(withIdentifier: "jsonCell_comJoint_1") as! CustomCell_Com_Detail
            ...
            let cell_4 = tableView.dequeueReusableCell(withIdentifier: "jsonCell_comJoint_1") as! CustomCell_Com_Detail
