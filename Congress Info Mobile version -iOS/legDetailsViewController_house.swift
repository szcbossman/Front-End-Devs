//
//  legDetailsViewControllerViewController_house.swift
//  CongressInfo
//
...
class legDetailsViewController_house: UIViewController,UITableViewDataSource,UITableViewDelegate {

    @IBOutlet weak var tblJSON_legHouseDetail: UITableView!
    @IBOutlet weak var legHouseAvatar: UIImageView!
    ...
    override func viewDidLoad() {
        ...
        self.legHouseAvatar.image = UIImage(data: data!)
    }

    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        
        if indexPath.section == 0 {
            let cell_0 = tableView.dequeueReusableCell(withIdentifier: "jsonCell_legHouse_1") as! CustomCell
            cell_0.text1_L.text = "First Name"
            cell_0.text1_R.text = (recData[0]["first_name"] as? String)!
            return cell_0
        }
        else if indexPath.section == 1 {
            let cell_1 = tableView.dequeueReusableCell(withIdentifier: "jsonCell_legHouse_1") as! CustomCell
            cell_1.text1_L.text = "Last Name"
            cell_1.text1_R.text = (recData[0]["last_name"] as? String)!
            return cell_1
        }
        else if indexPath.section == 2 {
            let cell_2 = tableView.dequeueReusableCell(withIdentifier: "jsonCell_legHouse_1") as! CustomCell
            cell_2.text1_L.text = "State"
            cell_2.text1_R.text = (recData[0]["state_name"] as? String)!
            return cell_2
        }
        else if indexPath.section == 3 {
            let cell_3 = tableView.dequeueReusableCell(withIdentifier: "jsonCell_legHouse_1") as! CustomCell
            ...
            let cell_4 = tableView.dequeueReusableCell(withIdentifier: "jsonCell_legHouse_1") as! CustomCell
            ...
            let cell_5 = tableView.dequeueReusableCell(withIdentifier: "jsonCell_legHouse_1") as! CustomCell
            cell_5.text1_L.text = "Chamber"
            cell_5.text1_R.text = (recData[0]["chamber"] as? String)!
            return cell_5
        }
        else if indexPath.section == 6{
            let cell_6 = tableView.dequeueReusableCell(withIdentifier: "jsonCell_legHouse_1") as! CustomCell
            ...
            let cell_7 = tableView.dequeueReusableCell(withIdentifier: "jsonCell_legHouse_2") as! CustomCell
            ...
            let cell_8 = tableView.dequeueReusableCell(withIdentifier: "jsonCell_legHouse_3") as! CustomCell
            ...
            let cell_9 = tableView.dequeueReusableCell(withIdentifier: "jsonCell_legHouse_1") as! CustomCell
            cell_9.text1_L.text = "Office No."
            cell_9.text1_R.text = (recData[0]["office"] as? String)!
            return cell_9
        }
        else  {
            let cell_10 = tableView.dequeueReusableCell(withIdentifier: "jsonCell_legHouse_1") as! CustomCell
