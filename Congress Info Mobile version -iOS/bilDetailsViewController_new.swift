//
//  bilDetailsViewController_new.swift
//  CongressInfo
//
...
class bilDetailsViewController_new: UIViewController,UITableViewDataSource,UITableViewDelegate {

    
    @IBOutlet weak var bill_officialTitle: UITextView!
    @IBOutlet weak var tblJSON_bilNewDetail: UITableView!
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if indexPath.section == 0 {
            let cell_0 = tableView.dequeueReusableCell(withIdentifier: "jsonCell_bilNew_1") as! CustomCell_Bill_ActiveDetail
            cell_0.text1_L.text = "Bill ID"
            cell_0.text1_R.text = (recData[0]["bill_id"] as? String)!
            return cell_0
        }
        else if indexPath.section == 1 {
            let cell_1 = tableView.dequeueReusableCell(withIdentifier: "jsonCell_bilNew_1") as! CustomCell_Bill_ActiveDetail
            cell_1.text1_L.text = "Bill Type"
            cell_1.text1_R.text = (recData[0]["bill_type"] as? String)!
            return cell_1
        }
        else if indexPath.section == 2 {
            let cell_2 = tableView.dequeueReusableCell(withIdentifier: "jsonCell_bilNew_1") as! CustomCell_Bill_ActiveDetail
            ...
            let cell_3 = tableView.dequeueReusableCell(withIdentifier: "jsonCell_bilNew_1") as! CustomCell_Bill_ActiveDetail
            ...
            let cell_4 = tableView.dequeueReusableCell(withIdentifier: "jsonCell_bilNew_2") as! CustomCell_Bill_ActiveDetail
            ...
            let cell_5 = tableView.dequeueReusableCell(withIdentifier: "jsonCell_bilNew_1") as! CustomCell_Bill_ActiveDetail
            cell_5.text1_L.text = "Chamber"
            cell_5.text1_R.text = (recData[0]["chamber"] as? String)!
            return cell_5
        }
        else if indexPath.section == 6{
            let cell_6 = tableView.dequeueReusableCell(withIdentifier: "jsonCell_bilNew_1") as! CustomCell_Bill_ActiveDetail
            ...
            let cell_7 = tableView.dequeueReusableCell(withIdentifier: "jsonCell_bilNew_1") as! CustomCell_Bill_ActiveDetail
            cell_7.text1_L.text = "Status"
            var statusStr = ""
            let history = recData[0]["history"]
            if history?["active"] as? String == "true" {
                statusStr = "Active"
            }
            else {
                statusStr = "New"
