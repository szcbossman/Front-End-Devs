...
app.controller("dataCtrl", function ($scope, $http) {
    ...
    $http.get('http://app102116-env.us-west-2.elasticbeanstalk.com?legislators').then(function (response) {
        //$scope.total = response.data.length;
        $scope.legislators = response.data.results;
        console.log($scope.legislators);
    });

    $http.get('http://app102116-env.us-west-2.elasticbeanstalk.com?billsActive').then(function (response) {
        $scope.billsActive = response.data.results;
        console.log($scope.billsActive);
    });

    $http.get('http://app102116-env.us-west-2.elasticbeanstalk.com?billsNew').then(function (response) {
        $scope.billsNew = response.data.results;
        console.log($scope.billsNew);
    });

    $http.get('http://app102116-env.us-west-2.elasticbeanstalk.com?committees').then(function (response) {
    ...
    $scope.legViewDetails = function(legID) {
    	...
    	$http.get('http://app102116-env.us-west-2.elasticbeanstalk.com?', config_0).then(function (response) {
    	...
    	$http.get('http://app102116-env.us-west-2.elasticbeanstalk.com?', config_2).then(function (response) {
        $scope.legCommittee = response.data.results;
        console.log($scope.legCommittee);
    	});
    	$http.get('http://app102116-env.us-west-2.elasticbeanstalk.com?', config_1).then(function (response) {
    ...
    $http.get('http://app102116-env.us-west-2.elasticbeanstalk.com?', config).then(function (response) {
